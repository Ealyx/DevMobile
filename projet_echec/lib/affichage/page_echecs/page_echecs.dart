...
import 'package:ChessArena/affichage/page_echecs/AffichageEchec.dart';
import 'package:ChessArena/affichage/page_acceuil/page_acceuil.dart';
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                setState(() {
                  plateau.chargerPartie(database);
